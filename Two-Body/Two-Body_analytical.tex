...
\begin{equation}
    \begin{split}
        \dot e 
        & = \frac{1}{G^2 m_1^6 m_2^6} {\left(1 +\frac{2EL^2(m_1 + m_2)}{m_1^3 m_2^3 G^2}\right)}^{-1/2} \cdot \\
        &  m_1^3 m_2^3 \left(EL^2 (\dot m_1 + \dot m_2) + (m_1 + m_2)(\dot E L^2 - 2 E L \dot L) \right.\\
        & \left. - EL^2(m_1 + m_2) (2 m_1^2 \dot m_1 m_2^3+ 3m_2^2 \dot m_2 m_1^3) \right)
    \end{split}
\end{equation}
